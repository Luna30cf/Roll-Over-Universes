 ...
 */
final class Version20250303161309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, balance NUMERIC(10, 2) DEFAULT NULL, picture_profile VARCHAR(255) DEFAULT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , phone_number INTEGER DEFAULT NULL, delivery_address VARCHAR(255) DEFAULT NULL)');
